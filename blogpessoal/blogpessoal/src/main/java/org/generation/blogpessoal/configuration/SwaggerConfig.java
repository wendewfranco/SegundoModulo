...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto Minha API Spring - Blog Pessoal")
	...
	private static Contact contact() {
		...
		return new Contact("Wendew Franco", "https://github.com/wendewfranco", "wendewfranco@gmail.com");
	}
